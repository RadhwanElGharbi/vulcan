...
atomic_json(ROOT/'tests/research-qualification-index.json',{'generated_at':now(),'scope':'Dated acquisition attempts; passing one AOI is not complete product qualification',
